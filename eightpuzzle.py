...
if __name__ == '__main__' :
    ...
    #solvePuzzle('1234567_8')
    '''gwidth, gheight = determineDimensions('_23546871')
    #gwidth, gheight = determineDimensions('0123456789abc_de')
    posmoves = fillPosMoves('_23546871')
    solvePuzzle('_23546871')
    #cProfile.run(solvePuzzle("0123456789a_bcde"))'''
